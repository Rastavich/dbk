// Local config
export const BASE_URI = 'http://192.168.20.7:1337';
export const BASE_LOGIN_URI = 'http://192.168.20.7:1337/auth/local';
export const GRAPHQL_URI = 'http://192.168.20.7:1337/graphql';

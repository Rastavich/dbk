// Local config
export const BASE_URI = 'http://172.19.117.180:1337';
export const BASE_LOGIN_URI = 'http://172.19.117.180:1337/auth/local';
export const GRAPHQL_URI = 'http://172.19.117.180:1337/graphql';
